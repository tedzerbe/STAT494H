...
for(i in seq_along(seeds)) {
  ...
  # Save the model
  model_name <- paste("model_with_", seeds[i], ".rds", sep = "")
...
write.csv(test_errors, "project/volume/models/model_with_errors.csv")
write.csv(vips, "project/volume/plots/model_with_vips.csv")
